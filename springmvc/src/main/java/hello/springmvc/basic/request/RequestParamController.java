...
public class RequestParamController {
    ...
    @ResponseBody // String으로 리턴하면 응답 body로 넣는다
    ...
    public String requestParamV4(String username, Long age) { // @RequestParam 생략 가능
    ...
    public String requestParamDefault(@RequestParam(required = true, defaultValue = "guest") String username,
                                       @RequestParam(required = false, defaultValue = "19") Integer age) {
